...
async function loadDashboardData() {
    try {
        ...
        document.getElementById('headerUserName').textContent = data.user.member_name;
        document.getElementById('headerUserRole').textContent = data.user.member_role || 'Employee';
